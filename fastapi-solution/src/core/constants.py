...
FILM_ID_DESCRIPTION = ('Shows detailed information about the movie '
...
FILM_SEARCH_LIST_DESCRIPTION = ('Shows a list of movies matching the '
                                'search criteria')
...
PERSON_ID_DESCRIPTION = ('Shows detailed information about the person. '
