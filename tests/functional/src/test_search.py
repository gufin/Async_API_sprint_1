...
async def test_search_film_fast_api(make_get_request):
    ...
    response = await make_get_request("/films/", params={"query": "High rating title"})
...
async def test_search_film_fast_api_invalid_title(make_get_request):
    response = await make_get_request("/films/", params={"query": "Harry Potter"})
...
async def test_search_person_fast_api(make_get_request):
    response = await make_get_request("/persons/", params={"query": "Madikhan"})
